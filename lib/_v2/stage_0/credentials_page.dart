                                    ...
                                    child: Center(
                                      child: AnimatedTextKit(
                                        ...
                                        onFinished: () async {
                                          globals.isOnline = await hasNetwork();
                                          //Authentication();
                                          //code  to authenticate through web3dart
                                          Navigator.of(context).pop();
                                          if(_isValidUser){
                                            if(globals.isOnline){
                                              // sendData();
                                              ...
                                              setState(() {
                                                _message = 'no internert connection !';
                                              });
                                            }
                                            ...
                                            setState(() {
                                              ...
                                              _message = 'wallet authentication failed';
                                            });
                                          }
                                        },
                                        animatedTexts: [
                                          TypewriterAnimatedText('check connectivity',
                                              curve: Curves.easeIn,speed: Duration(milliseconds: 120)),
                                          TypewriterAnimatedText('validating wallet',
                                              curve: Curves.easeIn,speed: Duration(milliseconds: 120)),
                                          TypewriterAnimatedText('authenticating...',
                                              curve: Curves.easeIn,speed: Duration(milliseconds: 120)),
                                          TypewriterAnimatedText('stay patient',
                                              curve: Curves.easeIn,speed: Duration(milliseconds: 120)),
                                          TypewriterAnimatedText(_status,
                                              textStyle: TextStyle(fontSize: 20,color: _textColor),
                                              curve: Curves.easeIn,speed: Duration(milliseconds: 120)),
                                        ],
                                      ),
                                    ),
